...
###----- PART 1: read file-----
#1.train dates:
filename_train = sys.path[0] + '/treebank/german/train/tiger-2.2.train.only-projective.conll06'
...
#2.testing
#1).read test dates:
filename_blind=sys.path[0]+'/treebank/german/dev/tiger-2.2.dev.conll06.blind'
...
#3).read evaluate dates:
filename_gold = sys.path[0] + '/treebank/german/dev/tiger-2.2.dev.conll06.gold'
